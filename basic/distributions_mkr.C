void distributions_mkr(){
    ...
    massAhist->Draw("hist");
    canvas1->Print("massAhist.pdf");
    
    TCanvas *canvas2 = new TCanvas();
    massBhist->Draw();
    canvas2->Print("massBhist.pdf");

    TCanvas *canvas3 = new TCanvas();
    massABhist->Draw();
    canvas3->Print("massABhist.pdf"); 
 
    TCanvas *canvas4 = new TCanvas();
    pzAhist->Draw();
    canvas4->Print("pzAhist.pdf");

    TCanvas *canvas5 = new TCanvas();
    pzBhist->Draw();
    canvas5->Print("pzBhist.pdf");

    TCanvas *canvas6 = new TCanvas();
    pzABhist->Draw();
    canvas6->Print("pzABhist.pdf");
    */
